...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay data-slot="alert-dialog-overlay" className={cn(className)} {...props} />
  )
}
...
function AlertDialogContent({
  ...
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      <AlertDialogPrimitive.Content data-slot="alert-dialog-content" className={cn(className)} {...props} />
    </AlertDialogPortal>
  )
}
